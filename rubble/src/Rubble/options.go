...
func ParseCommandLine() {
	...
	flag.StringVar(&DFDir ,"dfdir", DFDir, "What is the base DF directory?")
	flag.StringVar(&OutputDir ,"outputdir", OutputDir, "Where should Rubble write the generated raw files?")
	flag.StringVar(&ConfigDir ,"configdir", ConfigDir, "Rubble config dir.")
	flag.StringVar(&BaseDir ,"basedir", BaseDir, "Rubble base dir.")
	flag.StringVar(&AddonsDir ,"addonsdir", AddonsDir, "Rubble addons dir. (may be a path list)")
