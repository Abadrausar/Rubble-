...
// 	gt a b
// Returns "0" or "-1"
func CommandGt(state *nca4.State, params []*nca4.Value) {
	if len(params) != 2 {
...
// 	lt a b
// Returns "0" or "-1"
func CommandLt(state *nca4.State, params []*nca4.Value) {
	if len(params) != 2 {
...
// 	eq a b
// Returns "0" or "-1"
func CommandEq(state *nca4.State, params []*nca4.Value) {
	if len(params) != 2 {
