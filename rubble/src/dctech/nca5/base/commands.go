...
// Returns unchanged.
func CommandNop(state *nca5.State, params []*nca5.Value) {
}
...
func CommandRet(state *nca5.State, params []*nca5.Value) {
...
// 	exit [value]
// Returns value or unchanged.
func CommandExit(state *nca5.State, params []*nca5.Value) {
	if len(params) != 0 && len(params) != 1 {
		panic("Wrong number of params to exit.")
	}

	if len(params) > 0 {
		panic(nca5.ExitScript(params[0].String()))
	}
	panic(nca5.ExitScript(state.RetVal.String()))
}
...
// Returns value or unchanged.
func CommandBreak(state *nca5.State, params []*nca5.Value) {
	if len(params) != 0 && len(params) != 1 {
...
// Returns unchanged.
func CommandSetError(state *nca5.State, params []*nca5.Value) {
	if len(params) != 0 && len(params) != 1 {
...
// 	geterror
// Returns "-1" or "0".
func CommandGetError(state *nca5.State, params []*nca5.Value) {
	if len(params) != 0 {
...
// Returns unchanged.
func CommandCommand(state *nca5.State, params []*nca5.Value) {
	if len(params) < 2 {
		panic("Wrong number of params to command.")
	}
	if len(params) == 2 {
		// no params
		state.NewUserCommand(params[0].String(), params[1], make([]*nca5.Value, 0, 0))
...
// 	namespace name 
// Returns unchanged.
func CommandNamespace(state *nca5.State, params []*nca5.Value) {
	if len(params) != 1 {
...
// 	var name [value]
// Returns value or unchanged.
func CommandVar(state *nca5.State, params []*nca5.Value) {
...
func CommandDelVar(state *nca5.State, params []*nca5.Value) {
	if len(params) != 1 {
...
func CommandRun(state *nca5.State, params []*nca5.Value) {
	if len(params) < 1 {
...
// 	eval code
// Returns the return value of the last command in the code it runs.
func CommandEval(state *nca5.State, params []*nca5.Value) {
	if len(params) != 1 {
...
// 	evalinparent code
// Returns the return value of the last command in the code it runs.
func CommandEvalInParent(state *nca5.State, params []*nca5.Value) {
	if len(params) != 1 {
...
func CommandIf(state *nca5.State, params []*nca5.Value) {
	if len(params) != 2 && len(params) != 3 {
...
func CommandLoop(state *nca5.State, params []*nca5.Value) {
	if len(params) != 1 {
...
func CommandForEach(state *nca5.State, params []*nca5.Value) {
	if len(params) != 2 {
