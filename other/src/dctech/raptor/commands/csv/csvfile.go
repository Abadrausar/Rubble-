...
type CSVFile []*raptor.Value

func NewCSVFile() raptor.Indexable {
	tmp := make(CSVFile, 0, 20)
	return &tmp
}

func (this *CSVFile) Get(index string) *raptor.Value {
...
func (this *CSVFile) String() string {
	return raptor.GenericIndexableToString("csv:file", this)
}

func (this *CSVFile) CodeString() string {
