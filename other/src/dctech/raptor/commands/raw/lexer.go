...
func (this *rawlexer) Get(index string) *raptor.Value {
	if index == "id" {
		return raptor.NewValueString(this.curID)
	}
	...
	return raptor.NewValueString(this.curParams[val])
}
...
func (this *rawlexer) String() string {
	return raptor.GenericIndexableToString("raw:Lexer", this)
}

func (this *rawlexer) CodeString() string {
